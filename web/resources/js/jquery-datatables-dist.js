! function(t) {
    ...
    function s(t) {
        pe(t, "ordering", "bSort"), pe(t, "orderMulti", "bSortMulti"), pe(t, "orderClasses", "bSortClasses"), pe(t, "orderCellsTop", "bSortCellsTop"), pe(t, "order", "aaSorting"), pe(t, "orderFixed", "aaSortingFixed"), pe(t, "paging", "bPaginate"), pe(t, "pagingType", "sPaginationType"), pe(t, "pageLength", "iDisplayLength"), pe(t, "searching", "bFilter"), "boolean" == typeof t.sScrollX && (t.sScrollX = t.sScrollX ? "100%" : ""), "boolean" == typeof t.scrollX && (t.scrollX = t.scrollX ? "100%" : "");
        var e = t.aoSearchCols;
        if (e)
            for (var n = 0, a = e.length; a > n; n++) e[n] && o($t.models.oSearch, e[n])
    }

    function l(e) {
        pe(e, "orderable", "bSortable"), pe(e, "orderData", "aDataSort"), pe(e, "orderSequence", "asSorting"), pe(e, "orderDataType", "sortDataType");
        var n = e.aDataSort;
    ...
    function u(e) {
        ...
        t.extend(e.oBrowser, $t.__browser), e.oScroll.iBarWidth = $t.__browser.barWidth
    }
    ...
    function f(e, a) {
        var r = $t.defaults.column,
            o = e.aoColumns.length,
            i = t.extend({}, $t.models.oColumn, r, {
        ...
        s[o] = t.extend({}, $t.models.oSearch, s[o]), d(e, o, t(a).data())
    }
    ...
    function d(e, n, r) {
        ...
        r !== a && null !== r && (l(r), o($t.defaults.column, r), r.mDataProp === a || r.mData || (r.mData = r.mDataProp), r.sType && (i._sManualType = r.sType), r.className && !r.sClass && (r.sClass = r.className), t.extend(i, r), jt(i, r, "sWidth", "sWidthOrig"), r.iDataSort !== a && (i.aDataSort = [r.iDataSort]), jt(i, r, "aDataSort"));
        var f = i.mData,
            d = I(f),
    ...
    function h(t) {
        ...
        var r = t.oScroll;
        ("" !== r.sY || "" !== r.sX) && gt(t), kt(t, null, "column-sizing", [t])
    }
    ...
    function S(t) {
        ...
        for (e = 0, n = f.length; n > e; e++)
            ...
            for (r = 0, o = h.length; o > r; r++) {
                for (i = 0, s = d.length; s > i && (c[i] === a && (c[i] = T(t, i, e, "type")), u = h[r](c[i], t), u || r === h.length - 1) && "html" !== u; i++);
                if (u) {
                    l.sType = u;
                    break
                }
            ...
            for (i = n.length - 1; i >= 0; i--) {
                ...
                for (t.isArray(g) || (g = [g]), l = 0, u = g.length; u > l; l++)
                    if ("number" == typeof g[l] && g[l] >= 0) {
                        for (; p.length <= g[l];) f(e);
                        o(g[l], h)
                    } else if ("number" == typeof g[l] && g[l] < 0) o(p.length + g[l], h);
                else if ("string" == typeof g[l])
                    for (c = 0, d = p.length; d > c; c++)("_all" == g[l] || t(p[c].nTh).hasClass(g[l])) && o(c, h)
            }
        if (r)
        ...
        var r = function(e, n, o) {
            ...
            if ("" !== o)
                for (var c = x(o), f = 0, d = c.length; d > f; f++) {
                    if (i = c[f].match(ge), s = c[f].match(be), i) {
                        if (c[f] = c[f].replace(ge, ""), "" !== c[f] && (e = e[c[f]]), l = [], c.splice(0, f + 1), u = c.join("."), t.isArray(e))
                            for (var h = 0, p = e.length; p > h; h++) l.push(r(e[h], n, u));
                        var g = i[0].substring(1, i[0].length - 1);
                        e = "" === g ? l : l.join(g);
                        break
                    }
                    if (s) c[f] = c[f].replace(be, ""), e = e[c[f]]();
                    else {
    ...
    function A(e) {
        ...
        var n = function(e, r, o) {
            for (var i, s, l, u, c, f = x(o), d = f[f.length - 1], h = 0, p = f.length - 1; p > h; h++) {
                if (s = f[h].match(ge), l = f[h].match(be), s) {
                    if (f[h] = f[h].replace(ge, ""), e[f[h]] = [], i = f.slice(), i.splice(0, h + 1), c = i.join("."), t.isArray(r))
                        for (var g = 0, b = r.length; b > g; g++) u = {}, n(u, r[g], c), e[f[h]].push(u);
                    else e[f[h]] = r;
                    return
                }
                l && (f[h] = f[h].replace(be, ""), e = e[f[h]](r)), (null === e[f[h]] || e[f[h]] === a) && (e[f[h]] = {}), e = e[f[h]]
            }
            d.match(be) ? e = e[d.replace(be, "")](r) : e[d.replace(ge, "")] = r
        };
        return function(t, a) {
            return n(t, a, e)
        }
    ...
    function H(e, a, r, o) {
        var i, s, l, u, c, f = e.aoData[a],
            d = f._aData,
            h = [];
        if (null === f.nTr) {
            for (i = r || n.createElement("tr"), f.nTr = i, f.anCells = h, i._DT_RowIndex = a, N(e, f), u = 0, c = e.aoColumns.length; c > u; u++) l = e.aoColumns[u], s = r ? o[u] : n.createElement(l.sCellType), s._DT_CellIndex ={
                row: a,
                column: u
            }, h.push(s), r && !l.mRender && l.mData === u || t.isPlainObject(l.mData) && l.mData._ === u + ".display" || (s.innerHTML = T(e, a, u, "display")), l.sClass && (s.className += " " + l.sClass), l.bVisible && !r ? i.appendChild(s) : !l.bVisible && r && s.parentNode.removeChild(s), l.fnCreatedCell && l.fnCreatedCell.call(e.oInstance, s, T(e, a, u), d, a, u);
            kt(e, "aoRowCreatedCallback", null, [i, d, a])
        }
    ...
    function N(e, n) {
        ...
        if (a) {
            ...
            if (o && (a.id = o), r.DT_RowClass) {
                ...
                n.__rowc = n.__rowc ? he(n.__rowc.concat(i)) : i, t(a).removeClass(n.__rowc.join(" ")).addClass(r.DT_RowClass)
            }
    ...
    function O(e) {
        var n, a, r, o, i, s = e.nTHead,
            ...
            c = e.oClasses,
            f = e.aoColumns;
        for (u && (o = t("<tr/>").appendTo(s)), n = 0, a = f.length; a > n; n++) i = f[n], r = t(i.nTh).addClass(i.sClass), u && r.appendTo(o), e.oFeatures.bSort && (r.addClass(i.sSortingClass), i.bSortable !== !1 && (r.attr("tabindex", e.iTabIndex).attr("aria-controls", e.sTableId), xt(e, i.nTh, n))), i.sTitle != r[0].innerHTML && r.html(i.sTitle), Wt(e, "header")(e, r, i, c);
        if (u && B(e.aoHeader, s), t(s).find(">tr").attr("role", "row"), t(s).find(">tr>th, >tr>td").addClass(c.sHeaderTH), t(l).find(">tr>th, >tr>td").addClass(c.sFooterTH), null !== l) {
            var d = e.aoFooter[0];
            for (n = 0, a = d.length; a > n; n++) i = f[n], i.nTf = d[n].cell, i.sClass && t(i.nTf).addClass(i.sClass)
        }
    }
    ...
    function M(e) {
        ...
        if (-1 !== t.inArray(!1, n)) return void ht(e, !1);
        var r = [],
            o = 0,
            i = e.asStripeClasses,
            s = i.length,
        ...
        if (0 !== f.length)
            for (var p = c ? 0 : d, g = c ? e.aoData.length : h, v = p; g > v; v++) {
                var S = f[v],
                    m = e.aoData[S];
                null === m.nTr && H(e, S);
                var D = m.nTr;
                ...
                kt(e, "aoRowCallback", null, [D, m._aData, o, v]), r.push(D), o++
            } else {
                var _ = l.sZeroRecords;
                1 == e.iDraw && "ajax" == Ut(e) ? _ = l.sLoadingRecords : l.sEmptyTable && 0 === e.fnRecordsTotal() && (_ = l.sEmptyTable), r[0] = t("<tr/>", {
                    "class": s ? i[0] : ""
                }).append(t("<td />", {
                    valign: "top",
                    colSpan: b(e),
        ...
        kt(e, "aoHeaderCallback", "header", [t(e.nTHead).children("tr")[0], F(e), d, h, f]), kt(e, "aoFooterCallback", "footer", [t(e.nTFoot).children("tr")[0], F(e), d, h, f]);
        var C = t(e.nTBody);
        C.children().detach(), C.append(t(r)), kt(e, "aoDrawCallback", "draw", [e]), e.bSorted = !1, e.bFiltered = !1, e.bDrawing = !1
    }
    ...
    function U(e) {
        ...
        for (var s, l, u, c, f, d, h = e.sDom.split(""), p = 0; p < h.length; p++) {
            ...
            else if ("l" == l && o.bPaginate && o.bLengthChange) s = ut(e);
            else if ("f" == l && o.bFilter) s = $(e);
            else if ("r" == l && o.bProcessing) s = dt(e);
            else if ("t" == l) s = pt(e);
            else if ("i" == l && o.bInfo) s = at(e);
            else if ("p" == l && o.bPaginate) s = ct(e);
            else if (0 !== $t.ext.feature.length)
                for (var b = $t.ext.feature, v = 0, S = b.length; S > v; v++)
                    if (l == b[v].cFeature) {
                        s = b[v].fnInit(e);
                        break
                    }
    ...
    function B(e, n) {
        var a, r, o, i, s, l, u, c, f, d, h, p = t(n).children("tr"),
            g = function(t, e, n) {
                for (var a = t[e]; a[n];) n++;
                return n
            };
        ...
        for (o = 0, l = p.length; l > o; o++)
            for (a = p[o], c = 0, r = a.firstChild; r;) {
                if ("TD" == r.nodeName.toUpperCase() || "TH" == r.nodeName.toUpperCase())
                    for (f = 1 * r.getAttribute("colspan"), d = 1 * r.getAttribute("rowspan"), f = f && 0 !== f && 1 !== f ? f : 1, d = d && 0 !== d && 1 !== d ? d : 1, u = g(e, o, c), h = 1 === f ? !0 : !1, s = 0; f > s; s++)
                        for (i = 0; d > i; i++) e[o + i][u + s] = {
                            cell: r,
                            unique: h
                        }, e[o + i].nTr = a;
                r = r.nextSibling
    ...
    function J(e, n, a) {
        ...
        var f = {
            ...
            error: function(n, a) {
                var r = kt(e, null, "xhr", [e, null, e.jqXHR]); - 1 === t.inArray(!0, r) && ("parsererror" == a ? Rt(e, 0, "Invalid JSON response", 1) : 4 === n.readyState && Rt(e, 0, "Ajax error", 7)), ht(e, !1)
            }
        };
        e.oAjaxData = n, kt(e, null, "preXhr", [e, n]), e.fnServerData ? e.fnServerData.call(l, e.sAjaxSource, t.map(n, function(t, e) {
            ...
            url: s || e.sAjaxSource
        })) : t.isFunction(s) ? e.jqXHR = s.call(l, n, u, e) : (e.jqXHR = t.ajax(t.extend(f, s)), s.data = i)
    }

    function V(t) {
        return t.bAjaxDataGet ? (t.iDraw++, ht(t, !0), J(t, X(t), function(e) {
            q(t, e)
        }), !1) : !0
    }
    ...
    function X(e) {
        ...
        g("sEcho", e.iDraw), g("iColumns", s), g("sColumns", le(i, "sName").join(",")), g("iDisplayStart", h), g("iDisplayLength", p);
        var b = {
            draw: e.iDraw,
            columns: [],
            order: [],
    ...
    function q(t, e) {
        ...
        t.aiDisplay = t.aiDisplayMaster.slice(), t.bAjaxDataGet = !1, M(t), t._bInitComplete || st(t, e), t.bAjaxDataGet = !0, ht(t, !1)
    }
    ...
    function $(e) {
        ...
        var c = t("<div/>", {
            ...
            d = null !== e.searchDelay ? e.searchDelay : "ssp" === Ut(e) ? 400 : 0,
            h = t("input", c).val(i.sSearch).attr("placeholder", o.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", d ? ye(f, d) : f).bind("keypress.DT", function(t) {
    ...
    function Y(e) {
        for (var n, a, r = $t.ext.search, o = e.aiDisplay, i = 0, s = r.length; s > i; i++) {
    ...
    function Q(t, e, n, a, r, o) {
        var i, s, l, u = K(e, a, r, o),
            ...
            f = t.aiDisplayMaster;
        if (0 !== $t.ext.search.length && (n = !0), s = tt(t), e.length <= 0) t.aiDisplay = f.slice();
        else
    ...
    function tt(t) {
        ...
        for (n = 0, r = t.aoData.length; r > n; n++)
            if (l = t.aoData[n], !l._aFilterData) {
                for (i = [], a = 0, o = u.length; o > a; a++) e = u[a], e.bSearchable ? (s = T(t, n, a, "filter"), c[e.sType] && (s = c[e.sType](s)), null === s && (s = ""), "string" != typeof s && s.toString && (s = s.toString())) : s = "", s.indexOf && -1 !== s.indexOf("&") && (Se.innerHTML = s, s = me ? Se.textContent : Se.innerText), s.replace && (s = s.replace(/[\r\n]/g, "")), i.push(s);
    ...
    function rt(e) {
        ...
        if (0 !== n.length) {
            ...
            s !== i && (l += " " + a.sInfoFiltered), l += a.sInfoPostFix, l = ot(e, l);
    ...
    function it(t) {
        ...
        for (U(t), O(t), k(t, t.aoHeader), k(t, t.aoFooter), ht(t, !0), i.bAutoWidth && vt(t), e = 0, n = o.length; n > e; e++) a = o[e], a.sWidth && (a.nTh.style.width = yt(a.sWidth));
        kt(t, null, "preInit", [t]), W(t);
        var l = Ut(t);
        ("ssp" != l || s) && ("ajax" == l ? J(t, [], function(n) {
            var a = G(t, n);
            for (e = 0; e < a.length; e++) D(t, a[e]);
            t.iInitDisplayStart = r, W(t), ht(t, !1), st(t, n)
        }, t) : (ht(t, !1), st(t)))
    }
    ...
    function ut(e) {
        ...
        return e.aanFeatures.l || (f[0].id = a + "_length"), f.children().append(e.oLanguage.sLengthMenu.replace("_MENU_", l[0].outerHTML)), t("select", f).val(e._iDisplayLength).bind("change.DT", function() {
            lt(e, t(this).val()), M(e)
            ...
            fn: function(t) {
                if (r) {
                    var e, n, i = t._iDisplayStart,
                        ...
                        d = c ? 1 : Math.ceil(u / l),
                        h = a(f, d);
                    for (e = 0, n = s.p.length; n > e; e++) Wt(t, "pageButton")(t, s.p[e], e, h, f, d)
                } else a.fnUpdate(t, o)
            },
            sName: "pagination"
        })), i
    ...
    function ft(t, e, n) {
        var a = t._iDisplayStart,
            r = t._iDisplayLength,
            o = t.fnRecordsDisplay();
        0 === o || -1 === r ? a = 0 : "number" == typeof e ? (a = e * r, a > o && (a = 0)) : "first" == e ? a = 0 : "previous" == e ? (a = r >= 0 ? a - r : 0, 0 > a && (a = 0)) : "next" == e ? o > a + r && (a += r) : "last" == e ? a = Math.floor((o - 1) / r) * r : Rt(t, 0, "Unknown paging action: " + e, 5);
        var i = t._iDisplayStart !== a;
        return t._iDisplayStart = a, i && (kt(t, null, "page", [t]), n && M(t)), i
    }
    ...
    function pt(e) {
        ...
        var g = p.children(),
            ...
            v = g[1],
            S = f ? g[2] : null;
        return r && t(v).on("scroll.DT", function() {
    ...
    function gt(e) {
        var n, r, o, i, s, l, u, c, f, d = e.oScroll,
            g = d.sX,
            b = d.sXInner,
            v = d.sY,
            S = d.iBarWidth,
        ...
        e.scrollBarVis = V, P.children("thead, tfoot").remove(), H && (l = H.clone().prependTo(P), r = H.find("tr"), i = l.find("tr")), s = L.clone().prependTo(P), n = L.find("tr"), o = s.find("tr"), s.find("th, td").removeAttr("tabindex"), g || (x.width = "100%", m[0].style.width = "100%"), t.each(E(e, s), function(t, n) {
            u = p(e, t), n.style.width = e.aoColumns[u].sWidth
        }), H && bt(function(t) {
            t.style.width = ""
        }, i), f = P.outerWidth(), "" === g ? (j.width = "100%", O && (P.find("tbody").height() > T.offsetHeight || "scroll" == w.css("overflow-y")) && (j.width = yt(P.outerWidth() - S)), f = P.outerWidth()) : "" !== b && (j.width = yt(b), f = P.outerWidth()), bt(J, o), bt(function(e) {
            U.push(e.innerHTML), M.push(yt(t(e).css("width")))
        }, o), bt(function(e, n) {
            -1 !== t.inArray(e, k) && (e.style.width = M[n])
        }, n), t(o).height(0), H && (bt(J, i), bt(function(e) {
            B.push(e.innerHTML), W.push(yt(t(e).css("width")))
        }, i), bt(function(t, e) {
            t.style.width = W[e]
        }, r), t(i).height(0)), bt(function(t, e) {
            t.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + U[e] + "</div>", t.style.width = M[e]
        }, o), H && bt(function(t, e) {
            t.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + B[e] + "</div>", t.style.width = W[e]
        }, i), P.outerWidth() < f ? (c = T.scrollHeight > T.offsetHeight || "scroll" == w.css("overflow-y") ? f + S : f, O && (T.scrollHeight > T.offsetHeight || "scroll" == w.css("overflow-y")) && (j.width = yt(c - S)), ("" === g || "" !== b) && Rt(e, 1, "Possible column misalignment", 6)) : c = "100%", x.width = yt(c), D.width = yt(c), H && (e.nScrollFoot.style.width = yt(c)), v || O && (x.height = yt(R.offsetHeight + S));
        var X = P.outerWidth();
        C[0].style.width = yt(X), _.width = yt(X);
        var q = P.height() > T.clientHeight || "scroll" == w.css("overflow-y"),
            G = "padding" + (N.bScrollbarLeft ? "Left" : "Right");
        _[G] = q ? S + "px" : "0px", H && (F[0].style.width = yt(X), A[0].style.width = yt(X), A[0].style[G] = q ? S + "px" : "0px"), P.children("colgroup").insertBefore(P.children("thead")), w.scroll(), !e.bSorted && !e.bFiltered || e._drawHold || (T.scrollTop = 0)
    }
    ...
    function vt(n) {
        var a, r, o, i = n.nTable,
            ...
            C = _.bScrollOversize,
            T = i.style.width;
        for (T && -1 !== T.indexOf("%") && (m = T), a = 0; a < g.length; a++) r = s[g[a]], null !== r.sWidth && (r.sWidth = St(r.sWidthOrig, D), y = !0);
        if (C || !y && !c && !u && d == b(n) && d == S.length)
            for (a = 0; d > a; a++) {
                var w = p(n, a);
                null !== w && (s[w].sWidth = yt(S.eq(a).width()))
            } else {
                var x = t(i).clone().css("visibility", "hidden").removeAttr("id");
                x.find("tbody tr").remove();
                var I = t("<tr/>").appendTo(x.find("tbody"));
                for (x.find("thead, tfoot").remove(), x.append(t(n.nTHead).clone()).append(t(n.nTFoot).clone()), x.find("tfoot th, tfoot td").css("width", ""), S = E(n, x.find("thead")[0]), a = 0; a < g.length; a++) r = s[g[a]], S[a].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? yt(r.sWidthOrig) : "", r.sWidthOrig && c && t(S[a]).append(t("<div/>").css({
                    width: r.sWidthOrig,
                    margin: 0,
                    padding: 0,
                    border: 0,
                ...
                if (n.aoData.length)
                    for (a = 0; a < g.length; a++) o = g[a], r = s[o], t(mt(n, o)).clone(!1).append(r.sContentPadding).appendTo(I);
                ...
                for (a = 0; a < g.length; a++) {
                    var L = t(S[a]),
                        ...
                        R = _.bBounding ? Math.ceil(S[a].getBoundingClientRect().width) : L.outerWidth();
                    F += R, s[g[a]].sWidth = yt(R - P)
                }
                i.style.width = yt(F), A.remove()
            }
        if (m && (i.style.width = yt(m)), (m || c) && !n._reszEvt) {
            var j = function() {
                t(e).bind("resize.DT-" + n.sInstance, ye(function() {
                    h(n)
                }))
            };
    ...
    function _t(e) {
        ...
        for (t.isArray(d) && g(d), h && d.pre && g(d.pre), g(e.aaSorting), h && d.post && g(d.post), n = 0; n < p.length; n++)
            for (u = p[n][0], i = f[u].aDataSort, r = 0, o = i.length; o > r; r++) s = i[r], l = f[s].sType || "string", p[n]._idx === a && (p[n]._idx = t.inArray(p[n][1], f[s].asSorting)), c.push({
                src: u,
                col: s,
                dir: p[n][1],
                index: p[n]._idx,
                type: l,
                formatter: $t.ext.type.order[l + "-pre"]
            });
        return c
    }
    ...
    function Ct(t) {
        var e, n, a, r, o, i = [],
            ...
            u = (t.aoColumns, 0),
            c = t.aiDisplayMaster;
        for (S(t), o = _t(t), e = 0, n = o.length; n > e; e++) r = o[e], r.formatter && u++, At(t, r.col);
        if ("ssp" != Ut(t) && 0 !== o.length) {
            ...
            u === o.length ? c.sort(function(t, e) {
                ...
                for (r = 0; c > r; r++)
                    if (u = o[r],
                        n = f[u.col], a = d[u.col], s = a > n ? -1 : n > a ? 1 : 0, 0 !== s) return "asc" === u.dir ? s : -s;
    ...
    function Tt(t) {
        for (var e, n, a = t.aoColumns, r = _t(t), o = t.oLanguage.oAria, i = 0, s = a.length; s > i; i++) {
            var l = a[i],
                u = l.asSorting,
    ...
    function wt(e, n, r, o) {
        ...
        if ("number" == typeof l[0] && (l = e.aaSorting = [l]), r && e.oFeatures.bSortMulti) {
            var f = t.inArray(n, le(l, "0")); - 1 !== f ? (i = c(l[f], !0), null === i && 1 === l.length && (i = 0), null === i ? l.splice(f, 1) : (l[f][1] = u[i], l[f]._idx = i)) : (l.push([n, u[0], 0]), l[l.length - 1]._idx = 0)
    ...
    function xt(t, e, n, a) {
        var r = t.aoColumns[n];
        Nt(e, {}, function(e) {
            r.bSortable !== !1 && (t.oFeatures.bProcessing ? (ht(t, !0), setTimeout(function() {
                wt(t, n, e.shiftKey, a), "ssp" !== Ut(t) && ht(t, !1)
    ...
    function It(e) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (n = 0, a = o.length; a > n; n++) r = o[n].src, t(le(e.aoData, "anCells", r)).removeClass(i + (2 > n ? n + 1 : 3));
    ...
    function At(t, e) {
        var n, a = t.aoColumns[e],
            r = $t.ext.order[a.sSortDataType];
        r && (n = r.call(t.oInstance, t, e, g(t, e)));
        for (var o, i, s = $t.ext.type.order[a.sType + "-pre"], l = 0, u = t.aoData.length; u > l; l++) o = t.aoData[l], o._aSortData || (o._aSortData = []), (!o._aSortData[e] || r) && (i = r ? n[l] : T(t, l, e, "sort"), o._aSortData[e] = s ? s(i) : i)
    }
    ...
    function Lt(e) {
        ...
        if (e.oFeatures.bStateSave) {
            ...
            if (i && i.time) {
                var s = kt(e, "aoStateLoadParams", "stateLoadParams", [e, i]);
                if (-1 === t.inArray(!1, s)) {
                    ...
                    if (!(l > 0 && i.time < +new Date - 1e3 * l) && o.length === i.columns.length) {
                        for (e.oLoadedState = t.extend(!0, {}, i), i.start !== a && (e._iDisplayStart = i.start, e.iInitDisplayStart = i.start), i.length !== a && (e._iDisplayLength = i.length), i.order !== a && (e.aaSorting = [], t.each(i.order, function(t, n) {
                            ...
                            })), i.search !== a && t.extend(e.oPreviousSearch, nt(i.search)), n = 0, r = i.columns.length; r > n; n++) {
                            var u = i.columns[n];
                            u.visible !== a && (o[n].bVisible = u.visible), u.search !== a && t.extend(e.aoPreSearchCols[n], nt(u.search))
                        }
    ...
    function kt(e, n, a, r) {
        var o = [];
        if (n && (o = t.map(e[n].slice().reverse(), function(t) {
    ...
    function Bt(t, e) {
        var n = [],
            a = Ve.numbers_length,
            r = Math.floor(a / 2);
        return a >= e ? n = ce(0, e) : r >= t ? (n = ce(0, a - 2), n.push("ellipsis"), n.push(e - 1)) : t >= e - 1 - r ? (n = ce(e - (a - 2), e), n.splice(0, 0, "ellipsis"), n.splice(0, 0, 0)) : (n = ce(t - r + 2, t + r - 1), n.push("ellipsis"), n.push(e - 1), n.splice(0, 0, "ellipsis"), n.splice(0, 0, 0)), n.DT_el = "span", n
    }
    ...
    function Jt(t) {
        return function() {
            var e = [Pt(this[$t.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
            return $t.ext.internal[t].apply(this, e)
        }
    }
    var Vt, Xt, qt, Gt, $t = function(e) {
            this.$ = function(t, e) {
                return this.api(!0).$(t, e)
            }, this._ = function(t, e) {
                return this.api(!0).rows(t, e).data()
            }, this.api = function(t) {
                return new Xt(t ? Pt(this[Vt.iApiIndex]) : this)
            ...
            for (var h in $t.ext.internal) h && (this[h] = Jt(h));
            return this.each(function() {
                ...
                for (b = 0, h = T.length; h > b; b++) {
                    ...
                    if (w.nTable == this || w.nTHead.parentNode == this || w.nTFoot && w.nTFoot.parentNode == this) {
                        ...
                        return void Rt(w, 0, "Cannot reinitialise DataTable", 3)
                    }
                    if (w.sTableId == this.id) {
                        T.splice(b, 1);
                        break
                    }
                }(null === v || "" === v) && (v = "DataTables_Table_" + $t.ext._unique++, this.id = v);
                var F = t.extend(!0, {}, $t.models.oSettings, {
                ...
                ]), jt(F.oLanguage, g, "fnInfoCallback"), Ot(F, "aoDrawCallback", g.fnDrawCallback, "user"), Ot(F, "aoServerParams", g.fnServerParams, "user"), Ot(F, "aoStateSaveParams", g.fnStateSaveParams, "user"), Ot(F, "aoStateLoadParams", g.fnStateLoadParams, "user"), Ot(F, "aoStateLoaded", g.fnStateLoaded, "user"), Ot(F, "aoRowCallback", g.fnRowCallback, "user"), Ot(F, "aoRowCreatedCallback", g.fnCreatedRow, "user"), Ot(F, "aoHeaderCallback", g.fnHeaderCallback, "user"), Ot(F, "aoFooterCallback", g.fnFooterCallback, "user"), Ot(F, "aoInitComplete", g.fnInitComplete, "user"), Ot(F, "aoPreDrawCallback", g.fnPreDrawCallback, "user"), F.rowIdFn = I(g.rowId), u(F);
                var L = F.oClasses;
                if (g.bJQueryUI ? (t.extend(L, $t.ext.oJUIClasses, g.oClasses), g.sDom === _.sDom && "lfrtip" === _.sDom && (F.sDom = '<"H"lfr>t<"F"ip>'), F.renderer ? t.isPlainObject(F.renderer) && !F.renderer.header && (F.renderer.header = "jqueryui") : F.renderer = "jqueryui") : t.extend(L, $t.ext.classes, g.oClasses), C.addClass(L.sTable), F.iInitDisplayStart === a && (F.iInitDisplayStart = g.iDisplayStart, F._iDisplayStart = g.iDisplayStart), null !== g.iDeferLoading) {
                    F.bDeferLoading = !0;
                ...
                t.extend(!0, R, g.oLanguage), "" !== R.sUrl && (t.ajax({
                    ...
                    url: R.sUrl,
                    success: function(e) {
                        i(e), o(_.oLanguage, e), t.extend(!0, R, e), it(F)
                    },
                    error: function() {
                        it(F)
                    }
                ...
                var j = F.asStripeClasses,
                    H = C.children("tbody").find("tr").eq(0); - 1 !== t.inArray(!0, t.map(j, function(t) {
                    return H.hasClass(t)
                ...
                for (b = 0, h = N.length; h > b; b++) f(F, O ? O[b] : null);
                ...
                var W = F.oFeatures;
                if (g.bStateSave && (W.bStateSave = !0, Lt(F, g), Ot(F, "aoDrawCallback", Ft, "state_save")), g.aaSorting === a) {
                    var U = F.aaSorting;
                    for (b = 0, h = U.length; h > b; b++) U[b][1] = F.aoColumns[b].asSorting[0]
                }
                It(F), W.bSort && Ot(F, "aoDrawCallback", function() {
                    if (F.bSorted) {
                        var e = _t(F),
                            n = {};
                        t.each(e, function(t, e) {
                            n[e.src] = e.dir
                        }), kt(F, null, "order", [F, e, n]), Tt(F)
                    }
                }), Ot(F, "aoDrawCallback", function() {
                    (F.bSorted || "ssp" === Ut(F) || W.bDeferRender) && It(F)
                }, "sc");
                ...
                else(F.bDeferLoading || "dom" == Ut(F)) && y(F, t(F.nTBody).children("tr"));
                F.aiDisplay = F.aiDisplayMaster.slice(), F.bInitialised = !0, S === !1 && it(F)
            }), n = null, this
        },
        zt = {},
        Yt = /[\r\n]/g,
        ...
        re = function(t, e) {
            return zt[e] || (zt[e] = new RegExp(ve(e), "g")), "string" == typeof t && "." !== e ? t.replace(/\./g, "").replace(zt[e], ".") : t
        },
        oe = function(t, e, n) {
    ...
    Xt = function(e, n) {
        if (!(this instanceof Xt)) return new Xt(e, n);
        var a = [],
            r = function(t) {
                var e = Te(t);
                e && (a = a.concat(e))
        ...
        this.context = he(a), n && t.merge(this, n), this.selector = {
            rows: null,
            cols: null,
            opts: null
        }, Xt.extend(this, this, _e)
    }, $t.Api = Xt, t.extend(Xt.prototype, {
        any: function() {
            return 0 !== this.count()
        },
        concat: Ce.concat,
        ...
        filter: function(t) {
            var e = [];
            if (Ce.filter) e = Ce.filter.call(this, t, this);
            else
        ...
        join: Ce.join,
        indexOf: Ce.indexOf || function(t, e) {
        ...
        iterator: function(t, e, n, r) {
            ...
            for ("string" == typeof t && (r = n, n = e, e = t, t = !1), i = 0, s = p.length; s > i; i++) {
                ...
                if ("table" === e) o = n.call(b, p[i], i), o !== a && h.push(o);
                    ...
                    for (f = this[i], "column-rows" === e && (c = Le(p[i], g.opts)), l = 0, u = f.length; u > l; l++) d = f[l], o = "cell" === e ? n.call(b, p[i], d.row, d.column, i, l) : n.call(b, p[i], d, i, l, c), o !== a && h.push(o)
            }
            if (h.length || r) {
                var v = new Xt(p, t ? h.concat.apply([], h) : h),
                    S = v.selector;
                return S.rows = g.rows, S.cols = g.cols, S.opts = g.opts, v
            }
            return this
        },
        lastIndexOf: Ce.lastIndexOf || function() {
            return this.indexOf.apply(this.toArray.reverse(), arguments)
        },
        length: 0,
        map: function(t) {
            var e = [];
            if (Ce.map) e = Ce.map.call(this, t, this);
            else
        ...
        unique: function() {
            return new Xt(this.context, he(this))
        },
        unshift: Ce.unshift
    }), Xt.extend = function(e, n, a) {
        if (a.length && n && (n instanceof Xt || n.__dt_wrapper)) {
            var r, o, i, s = function(t, e, n) {
                return function() {
                    var a = e.apply(t, arguments);
                    return Xt.extend(a, a, n.methodExt), a
                }
            };
            for (r = 0, o = a.length; o > r; r++) i = a[r], n[i.name] = "function" == typeof i.val ? s(e, i.val, i) : t.isPlainObject(i.val) ? {} : i.val, n[i.name].__dt_wrapper = !0, Xt.extend(e, n[i.name], i.propExt)
        }
    }, Xt.register = qt = function(e, n) {
        if (t.isArray(e))
            for (var a = 0, r = e.length; r > a; a++) Xt.register(e[a], n);
        else {
            ...
            for (o = 0, i = u.length; i > o; o++) {
                ...
                d || (d = {
                    ...
                    methodExt: [],
                    propExt: []
                }, c.push(d)), o === i - 1 ? d.val = n : c = l ? d.methodExt : d.propExt
            }
        }
    }, Xt.registerPlural = Gt = function(e, n, r) {
        Xt.register(e, r), Xt.register(n, function() {
            var e = r.apply(this, arguments);
            return e === this ? this : e instanceof Xt ? e.length ? t.isArray(e[0]) ? new Xt(e.context, e[0]) : e[0] : a : e
        })
    };
    var we = function(e, n) {
        ...
        return t(a).filter(e).map(function() {
            var e = t.inArray(this, a);
            return n[e]
        }).toArray()
    };
    qt("tables()", function(t) {
        return t ? new Xt(we(t, this.context)) : this
    }), qt("table()", function(t) {
        var e = this.tables(t),
            n = e.context;
    ...
    var Ie = function(e, n, r, o, i) {
            ...
            for (n && "string" !== p && "function" !== p && n.length !== a || (n = [n]), u = 0, c = n.length; c > u; u++)
                for (l = n[u] && n[u].split ? n[u].split(",") : [n[u]], f = 0, d = l.length; d > f; f++) s = r("string" == typeof l[f] ? t.trim(l[f]) : l[f]), s && s.length && (h = h.concat(s));
            var g = Vt.selector[e];
            if (g.length)
        ...
        Le = function(e, n) {
            var a, r, o, i = [],
                ...
                c = n.order,
                f = n.page;
            if ("ssp" == Ut(e)) return "removed" === u ? [] : ce(0, l.length);
            if ("current" == f)
                for (a = e._iDisplayStart, r = e.fnDisplayEnd(); r > a; a++) i.push(s[a]);
            else if ("current" == c || "applied" == c) i = "none" == u ? l.slice() : "applied" == u ? s.slice() : t.map(l, function(e) {
    ...
    qt("rows()", function(e, n) {
        ...
        return this.iterator("row", function(e, n, r) {
            var o, i, s, l, u, c, f = e.aoData,
                d = f[n];
            for (f.splice(n, 1), o = 0, i = f.length; i > o; o++)
                if (u = f[o], c = u.anCells, null !== u.nTr && (u.nTr._DT_RowIndex = o), null !== c)
                    for (s = 0, l = c.length; l > s; s++) c[s]._DT_CellIndex.row = o;
            P(e.aiDisplayMaster, n), P(e.aiDisplay, n), P(t[r], n, !1), Mt(e);
    ...
    var Re = function(e, n, a, r) {
        ...
        Ne = function(t) {
            var e = new Xt(t),
                ...
                o = "destroy" + n,
                i = t.aoData;
            e.off(a + " " + r + " " + o), le(i, "_details").length > 0 && (e.on(a, function(n, a) {
                t === a && e.rows({
                    page: "current"
    ...
    }), qt([ke + ".show()", Me + ".show()"], function() {
        return He(this, !0), this
    }), qt([ke + ".hide()", Me + ".hide()"], function() {
        return He(this, !1), this
    }), qt([ke + ".remove()", Me + ".remove()"], function() {
        return je(this), this
    }), qt(ke + ".isShown()", function() {
        var t = this.context;
    ...
    var We = /^(.+):(name|visIdx|visible)$/,
        ...
        Ee = function(e, n, r) {
            var o, i, s, l, u = e.aoColumns,
                c = u[n],
                f = e.aoData;
            if (r === a) return c.bVisible;
            if (c.bVisible !== r) {
                if (r) {
                    var d = t.inArray(!0, le(u, "bVisible"), n + 1);
                    for (i = 0, s = f.length; s > i; i++) l = f[i].nTr, o = f[i].anCells, l && l.insertBefore(o[n], o[d] || null)
                } else t(le(e.aoData, "anCells", n)).detach();
                c.bVisible = r, k(e, e.aoHeader), k(e, e.aoFooter), Ft(e)
            }
        };
    qt("columns()", function(e, n) {
        ...
        var n = this.iterator("column", function(e, n) {
            return t === a ? e.aoColumns[n].bVisible : void Ee(e, n, t)
        });
        return t !== a && (this.iterator("column", function(n, a) {
            kt(n, null, "column-visibility", [n, a, t, e])
    ...
    var Je = function(e, n, r) {
        var o, i, s, l, u, c, f, d = e.aoData,
            ...
            v = function(n) {
                ...
                if (null === n || n === a || r) {
                    for (i = [], s = 0, l = h.length; l > s; s++)
                        for (o = h[s], u = 0; b > u; u++) c = {
                            row: o,
                            column: u
                        }, r ? (f = d[o], n(c, T(e, o, u), f.anCells ? f.anCells[u] : null) && i.push(c)) : i.push(c);
                    return i
                }
                ...
                return p.length || !n.nodeName ? p : (f = t(n).closest("*[data-dt-row]"), f.length ? [{
                    row: f.data("dt-row"),
    ...
    qt("cells()", function(e, n, r) {
            ...
            return e === a ? 0 !== i.length ? i[0].oPreviousSearch.sSearch : a : this.iterator("table", function(a) {
                a.oFeatures.bFilter && z(a, t.extend({}, a.oPreviousSearch, {
                    sSearch: e + "",
                    bRegex: null === n ? !1 : n,
                    bSmart: null === r ? !0 : r,
            ...
            for (var e, n, a = $t.version.split("."), r = t.split("."), o = 0, i = r.length; i > o; o++)
                if (e = parseInt(a[o], 10) || 0, n = parseInt(r[o], 10) || 0, e !== n) return e > n;
            return !0
        }, $t.isDataTable = $t.fnIsDataTable = function(e) {
            var n = t(e).get(0),
                a = !1;
            return t.each($t.settings, function(e, r) {
            ...
            var a = t.map($t.settings, function(n) {
                return !e || e && t(n.nTable).is(":visible") ? n.nTable : void 0
            });
            return n ? new Xt(a) : a
        }, $t.camelToHungarian = o, qt("$()", function(e, n) {
            ...
            return n = n || !1, this.iterator("table", function(a) {
                ...
                var b = t.inArray(a, $t.settings); - 1 !== b && $t.settings.splice(b, 1)
            })
            ...
            oSearch: t.extend({}, $t.models.oSearch),
            sAjaxDataProp: "data",
            sAjaxSource: null,
            sDom: "lfrtip",
            searchDelay: null,
        ...
        function() {
            ...
            t.extend($t.ext.oJUIClasses, $t.ext.classes, {
                            ...
                            if (v = a[o], t.isArray(v)) {
                                ...
                                switch (l = null, u = "", v) {
                                    ...
                                    case "previous":
                                        ...
                                        break;
                                    case "next":
                                        l = d.sNext, u = v + (s - 1 > i ? "" : " " + f.sPageButtonDisabled);
                                        break;
                                    case "last":
                                        l = d.sLast, u = v + (s - 1 > i ? "" : " " + f.sPageButtonDisabled);
                                        break;
                                    default:
                                        l = v + 1, u = i === v ? f.sPageButtonActive : ""
                                }
                                null !== l && (b = t("<a>", {
    ...
    }), t.extend($t.ext.type.detect, [function(t, e) {
    ...
    }), t.fn.dataTable = $t, $t.$ = t, t.fn.dataTableSettings = $t.settings, t.fn.dataTableExt = $t.ext, t.fn.DataTable = function(e) {
